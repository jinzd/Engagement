...
import {Container, Row, Col, Card, CardBody, Media, Form, FormGroup, Button, Input,FormFeedback} from 'reactstrap'
        ...
        <Col>
          ...
          <Row>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Button disabled={name && username && email && password ? false : true} className='dark-btn-full-width' color='info'> Create </Button>
            </Form>
              <Button onClick={()=>history.push('/signin')} color='link' className="center">
